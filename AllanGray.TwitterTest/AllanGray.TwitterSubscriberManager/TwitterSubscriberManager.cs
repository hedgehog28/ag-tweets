...
namespace AllanGray.TwitterSubscriberManager
{
	public class TwitterSubscriberManager : ITwitterSubscriberManager
	{
		...
		public TwitterSubscriberManager(string fileName="")
		{
		...
		private void Initialize()
		{
			...
			{
				var userFile = Environment.GetEnvironmentVariable("userfile");
				if (!string.IsNullOrEmpty(userFile)) //just so that the unit tests will work
				{
